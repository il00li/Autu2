...
def generate_execution_plan(description):
    ...
    2. احرص على أن يكون البوت في ملف واحد
    3. صمم واجهة المستخدم والأزرار المناسبة inline keyboard 
    4. حدد الوظائف الأساسية والإضافية
    5. اجعل الخطة شاملة وجاهزة للتنفيذ من المرة الاولى
    6.  تأكد أن لا شيء ناقص او تؤجلة للوقت اللاحق
...
def generate_code_from_plan(plan):
    ...
    المتطلبات الأساسية:
    1. استخدم مكتبة مناسبة حسب الوصف المقدم
